...
public class PlatformAccessConfigsAction implements Action<PlatformAccessConfigsTestDto> {
    ...
    @Override
    public PlatformAccessConfigsTestDto action(TestContext testContext, PlatformAccessConfigsTestDto entity, CloudbreakClient cloudbreakClient) throws Exception {
