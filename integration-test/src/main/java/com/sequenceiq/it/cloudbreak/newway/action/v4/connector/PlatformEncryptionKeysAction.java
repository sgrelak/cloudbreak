...
public class PlatformEncryptionKeysAction implements Action<PlatformEncryptionKeysTestDto> {
    ...
    @Override
    public PlatformEncryptionKeysTestDto action(TestContext testContext, PlatformEncryptionKeysTestDto entity, CloudbreakClient cloudbreakClient) throws Exception {
