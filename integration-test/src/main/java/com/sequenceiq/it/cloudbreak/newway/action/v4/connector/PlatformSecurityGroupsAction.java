...
public class PlatformSecurityGroupsAction implements Action<PlatformSecurityGroupsTestDto> {
    ...
    @Override
    public PlatformSecurityGroupsTestDto action(TestContext testContext, PlatformSecurityGroupsTestDto entity, CloudbreakClient cloudbreakClient) throws Exception {
