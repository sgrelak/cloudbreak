...
public class MaintenanceModeDisableAction implements Action<StackTestDto> {

    private static final Logger LOGGER = LoggerFactory.getLogger(MaintenanceModeDisableAction.class);

    private MaintenanceModeV4Request request;

    public MaintenanceModeDisableAction() {
        this.request = new MaintenanceModeV4Request();
        this.request.setStatus(MaintenanceModeStatus.DISABLED);
    }
