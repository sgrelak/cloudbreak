...
public abstract class AbstractCloudbreakDto<R, S, T extends CloudbreakEntity> extends Entity implements CloudbreakEntity {
    ...
    protected AbstractCloudbreakDto(String newId) {
        super(newId);
    }

    protected AbstractCloudbreakDto(R request, TestContext testContext) {
