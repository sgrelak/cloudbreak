...
@Prototype
public class ClusterEntity extends AbstractCloudbreakDto<ClusterV4Request, ClusterV4Response, ClusterEntity> {
    ...
    public ClusterEntity valid() {
        ...
        return withUserName("admin")
                ...
                .withAmbari(getTestContext().init(AmbariDto.class));
    }
    ...
    public ClusterEntity withAmbari() {
        AmbariDto ambari = getTestContext().get(AmbariDto.class);
        return withAmbari(ambari);
    }

    public ClusterEntity withAmbari(String key) {
        AmbariDto ambari = getTestContext().get(key);
        return withAmbari(ambari);
    }

    public ClusterEntity withAmbari(AmbariDto ambariRequest) {
    ...
    public ClusterEntity withGateway(String key) {
        GatewayDto gatewayDto = getTestContext().get(key);
        getRequest().setGateway(gatewayDto.getRequest());
        return this;
    }
