...
public class SharedServiceTest extends AbstractIntegrationTest {
    ...
    public void testCreateDatalakeCluster(MockedTestContext testContext) {
        ...
        testContext
                .given(HIVE, DatabaseTestDto.class)
                .withRequest(hiveRds)
                .withName(hiveRdsName)
                .when(databaseTestClient.createV4())
                .given(RANGER, DatabaseTestDto.class)
                .withRequest(rangerRds)
                .withName(rangerRdsName)
                .when(databaseTestClient.createV4())
                .given(LdapTestDto.class)
                .withRequest(ldapRequest(ldapName))
                .withName(ldapName)
                ...
                .given(MASTER.name(), InstanceGroupEntity.class)
                .valid()
