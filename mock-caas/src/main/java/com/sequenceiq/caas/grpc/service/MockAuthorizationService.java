...
public class MockAuthorizationService
  ...
  public void checkRight(
      CheckRightRequest request,
      StreamObserver<CheckRightResponse> responseObserver) {
  ...
  @Override
  public void hasRights(
      HasRightsRequest request,
      StreamObserver<HasRightsResponse> responseObserver) {
    checkArgument(!Strings.isNullOrEmpty(request.getActorCrn()));
